        ...
        >
          ...
          <p>Log Out</p>
            ...
            function ChannelComponent() {
                const [channelTitle, setChannelTitle] = useState("vite Vikings Channel"); //holding channel title
                
                const updateChannelTitle = () => {
                    setChannelTitle("Vite Vikings Channel"); //function update (updating channel title)
                };
            return (
            ...
            <h1 className='channel-title'>{ChannelTitle}</h1>
            );
            }
                ...
                function Message({ senderName, messageContent, messageDate }) {
                 ...
                 return (
                  ...
                  <div className="reply.box">
                    <textarea className="reply-textarea" placeholder="type your reply here..." rows={3} cols={50} value={replyText} onChange={handleChange}/>
                    <button className="reply-button" onClick={handleReply} disabled={replyText.trim}>Reply</button>
                  </div>
                  </div>
                  );
            }
