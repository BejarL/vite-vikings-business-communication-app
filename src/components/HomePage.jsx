...
function HomePage() {
  const backgroundImageUrl = useFirebaseImage("bg-images/1.png");
  ...
  return (
    <>
      ...
      >
        <Card className="Card-1  bg-teal-400">
        ...
        <Card className="Card-2 bg-teal-400">
          <img className="img2" src={img2} />
          <div>
            <p>
              {" "}
              Want to add a coworker or friend? Use Phone number, email, or
              their name to find them.
            </p>
          </div>
          <svg
          ...
          >
            <g fill="currentColor">
              <path d="M12.5 16a3.5 3.5 0 1 0 0-7a3.5 3.5 0 0 0 0 7m.5-5v1h1a.5.5 0 0 1 0 1h-1v1a.5.5 0 0 1-1 0v-1h-1a.5.5 0 0 1 0-1h1v-1a.5.5 0 0 1 1 0m-2-6a3 3 0 1 1-6 0a3 3 0 0 1 6 0M8 7a2 2 0 1 0 0-4a2 2 0 0 0 0 4"></path>
        ...
        <div
          className="Logo bg-amber-500 position-relative top-0 end-0"
          style={{
            backgroundImage: `url(${backgroundImageUrl})`,
            backgroundSize: "cover",
            backgroundPosition: "center",
