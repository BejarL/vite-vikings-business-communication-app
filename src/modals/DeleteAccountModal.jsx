...
export default function DeleteAccountModal({ deleteProfile }) {
  ...
  return (
    <div>
      ...
      className="py-3 px-4 mt-3 inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-teal-900 text-white hover:bg-teal-600 disabled:opacity-50 disabled:pointer-events-none dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600">
        Delete Account
      </button>
      <Modal
        show={openModal}
